...
?>
                        ...
                        <div class="card">
                            <img src="../assets/img/spinach.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Spinach</h1>
                            <p class="price">$4.99</p>
                            <p>Spinach is a nutrient-rich leafy green vegetable that is highly regarded for its health benefits and culinary versatility. With its vibrant green color and tender leaves, spinach is a popular choice among health-conscious individuals and culinary enthusiasts alike. Packed with vitamins, minerals, and antioxidants, spinach is known for its nutritional value. It is an excellent source of vitamins A, C, and K, as well as folate, iron, and calcium. These nutrients contribute to overall well-being, supporting healthy vision, immune function, bone health, and red blood cell production. Spinach has a mild, slightly earthy flavor that pairs well with a variety of dishes. It can be enjoyed both raw and cooked, making it a versatile ingredient in salads, smoothies, stir-fries, soups, and casseroles.
                          <p><button onclick="window.location.href='/products/spinach.php';">Add to Cart</button>
                    </form>
