...
?>
                        <div class="card">
                            <img src="../assets/img/cherry.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Cherries</h1>
                            <p class="price">$9.99</p>
                            <p>These vibrant fruits are particularly rich in antioxidants, such as anthocyanins, which give cherries their deep red color. Antioxidants play a crucial role in protecting the body against oxidative stress, reducing inflammation, and promoting overall well-being. Along with their antioxidant content, cherries are a good source of vitamin C. This essential vitamin supports immune function, collagen synthesis, and tissue repair. Consuming cherries can help boost your daily intake of vitamin C, providing a natural immune system boost and supporting the health of your skin, bones, and blood vessels.
                          <p><button onclick="window.location.href='/products/cherry.php';">Add to Cart</button>
                    </form>
