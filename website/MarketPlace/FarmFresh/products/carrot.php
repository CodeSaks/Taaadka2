...
?>
                        <div class="card">
                            <img src="../assets/img/carrot.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Carrots</h1>
                            <p class="price">$6.99</p>
                            <p>Carrots are a versatile and vibrant root vegetable that not only add a pop of color to dishes but also offer a plethora of nutritional benefits. With their sweet and earthy flavor, carrots are a popular choice for both raw and cooked consumption, making them a staple in various cuisines.One of the standout features of carrots is their high content of beta-carotene, a precursor to vitamin A. This powerful antioxidant is known for its role in promoting healthy vision, supporting immune function, and maintaining healthy skin. Consuming carrots regularly can help boost your vitamin A intake and provide valuable support for overall eye health. In addition to vitamin A, carrots contain other essential vitamins and minerals. They are a good source of vitamin K, which plays a crucial role in blood clotting and bone health. Carrots also provide vitamin C, an antioxidant that aids in collagen synthesis, supports immune function, and contributes to the overall health of your skin.
                          <p><button onclick="window.location.href='/products/carrot.php';">Add to Cart</button>
                    </form>
