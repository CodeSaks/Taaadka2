...
?>
                        <div class="card">
                            <img src="../assets/img/apple.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Apples</h1>
                            <p class="price">$13.99</p>
                            <p>Indulge in the rich and decadent taste of our chocolate protein powder! Made with high-quality whey protein, this powder is the perfect addition to your post-workout routine or anytime you need a delicious and nutritious snack. With a smooth and creamy texture and a delicious chocolate flavor, it's easy to see why our chocolate protein powder is a customer favorite. Plus, it's packed with essential amino acids and nutrients to help support your fitness goals and keep you feeling energized throughout the day. Whether you mix it with water, milk, or your favorite smoothie ingredients, our chocolate protein powder is the perfect way to satisfy your cravings and nourish your body at the same time. 
                          <p><button onclick="window.location.href='/products/apple.php';">Add to Cart</button>
                    </form>
