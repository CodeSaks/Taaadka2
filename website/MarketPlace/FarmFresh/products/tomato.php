...
?>
                     ...
                     <div class="card">
                            <img src="../assets/img/tomato.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Tomatoes</h1>
                            <p class="price">$9.99</p>
                            <p>Tomatoes are low in calories and high in essential nutrients, such as vitamin C, potassium, and lycopene, which is a powerful antioxidant. They also contain dietary fiber, which is important for maintaining digestive health. Tomatoes can be enjoyed raw in salads, sandwiches, and as a snack, or cooked in various dishes such as soups, sauces, and stews. They are a popular ingredient in Mediterranean cuisine, and are used in many traditional dishes like pizza and pasta sauces.
                          <p><button onclick="window.location.href='/products/tomato.php';">Add to Cart</button></p>
                         </div>
