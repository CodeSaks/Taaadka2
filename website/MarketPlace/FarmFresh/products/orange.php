...
?>
                        <div class="card">
                            <img src="../assets/img/orange.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Oranges</h1>
                            <p class="price">$18.99</p>
                            <p>Oranges are not only delicious and refreshing but also pack a powerful nutritional punch. They are renowned for their high vitamin C content, with just one medium-sized orange providing over 100% of the recommended daily intake of this immune-boosting vitamin. Along with vitamin C, oranges are a good source of dietary fiber, supporting healthy digestion and a well-functioning digestive system. These citrus fruits also offer a decent amount of folate, which is important for cell growth and red blood cell production. Additionally, oranges contribute potassium, an essential mineral for maintaining proper heart and muscle function. With their array of vitamins and minerals, including vitamin A, calcium, magnesium, and vitamin B6 in smaller amounts, oranges offer a wholesome package of nutrients that contribute to overall health and well-being. 
                          <p><button onclick="window.location.href='/products/orange.php';">Add to Cart</button>
                    </form>
