...
?>
                        <div class="card">
                            <img src="../assets/img/peppers.jpg" alt="Denim Jeans" style="max-height:1000px; max-width:1000px;">
                            <h1>Assorted Peppers</h1>
                            <p class="price">$12.99</p>
                            <p>The assortment of peppers offers a delightful combination of flavors, colors, and spice levels, making them a versatile ingredient in the culinary world. Each type of pepper brings its own unique characteristics to dishes, allowing for a diverse range of tastes and heat intensities. Bell peppers, available in red, yellow, orange, and green varieties, offer a mild and sweet flavor. They are commonly used in salads, stir-fries, fajitas, and stuffed pepper recipes. Bell peppers are also valued for their vibrant colors, which add visual appeal to dishes.
                          <p><button onclick="window.location.href='/products/peppers.php';">Add to Cart</button>
                    </form>
