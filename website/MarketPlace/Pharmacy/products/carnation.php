    ...
    <div id="page">
        ...
        <div class="feature">
            <div class="feature-inner">
                <h1>Carnation Breakfast Essentials</h1>
            </div>
        </div>
        ...
        <div id="content">
            <div id="content-inner">
                ...
                <main id="contentbar">
                    ...
                    <div class="card">
                            <img src="/marketplace/pharmacy/images/medicines/medicine10.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Carnation Breakfast Essentials</h1>
                            <p class="price">$10.99</p>
                            <p>Carnation Breakfast Essentials Rich Milk Chocolate Nutritional Powder Drink mix </p>
                            <p><button onclick="window.location.href='products/carnation.php';">Details</button></p>
                          </div>
                    </div>
