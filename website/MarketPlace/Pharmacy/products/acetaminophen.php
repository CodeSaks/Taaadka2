        ...
        <div id="content">
            <div id="content-inner">
                ...
                <main id="contentbar">
                    ...
                    <div class="card">
                            <img src="/marketplace/pharmacy/images/medicines/medicine6.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Tylenol Acetaminophen</h1>
                            <p class="price">$3.99</p>
                            <p>Relieves pain and fever.</p>
                            <p><button onclick="window.location.href='products/acetaminophen.php';">Details</button></p>
                          </div>
                    </div>
