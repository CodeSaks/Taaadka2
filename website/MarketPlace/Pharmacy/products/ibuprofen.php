            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/marketplace/pharmacy/images/medicines/medicine2.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Ibuprofen Tablets</h1>
                            <p class="price">$9.99</p>
                            <p>Pain Reliever/Fever Reducer. Nonsteroidal Anti-Inflammatory Drug.</p>
                            <p><button onclick="window.location.href='products/ibuprofen.php';">Add to Cart</button></p>
                          </div>
                    </div>
