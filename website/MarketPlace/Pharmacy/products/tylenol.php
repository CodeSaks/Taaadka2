            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/marketplace/pharmacy/images/medicines/medicine1.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Tylenol(For Adults)</h1>
                            <p class="price">$10.99</p>
                            <p>Relieves headache, sore throat and cough</p>
                            <p><button onclick="window.location.href='products/tylenol.php';">Add to Cart</button></p>
                          </div>
                    </div>
