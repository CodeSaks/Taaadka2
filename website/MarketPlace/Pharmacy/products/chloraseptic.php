    ...
    <div id="page">
        ...
        <div class="feature">
            <div class="feature-inner">
                <h1>Chloraseptic Sore Throat Spray</h1>
            </div>
        </div>
        ...
        <div id="content">
            <div id="content-inner">
                ...
                <main id="contentbar">
                    ...
                    <div class="card">
                            <img src="/marketplace/pharmacy/images/medicines/medicine8.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Chloraseptic Sore Throat Spray</h1>
                            <p class="price">$2.99</p>
                            <p> Provides fast relief from sore throat.</p>
                            <p><button onclick="window.location.href='products/chloraseptic.php';">Details</button></p>
                          </div>
                    </div>
