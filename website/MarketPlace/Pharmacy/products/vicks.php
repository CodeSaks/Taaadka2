        ...
        <div id="content">
            <div id="content-inner">
                ...
                <main id="contentbar">
                    ...
                    <div class="card">
                            <img src="/marketplace/pharmacy/images/medicines/medicine7.png" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            <h1>Vicks Vapo Rub</h1>
                            <p class="price">$2.99</p>
                            <p> An ointment for relief from cough and sore throat.</p>
                            <p><button onclick="window.location.href='products/vicks.php';">Details</button></p>
                          </div>
                    </div>
