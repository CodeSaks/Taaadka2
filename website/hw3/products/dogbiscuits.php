<?php
                    $cookie_name = "last_5_pages_petshop";
    ...
    <div id="page">
        <header id="header">
            <div id="header-inner">
                ...
                <div id="top-nav">
                    <ul>
                        <li><a href="/marketplace/petshop/index.html">Home</a></li>
                        <li><a href="/marketplace/petshop/about.html">About</a></li>
                        <li><a href="/marketplace/petshop/products.html">Products/Services</a></li>
                        <li><a href="/marketplace/petshop/news.html">News</a></li>
                        <li><a href="/marketplace/petshop/contacts.php">Contact</a></li>
                        <li><a href="/marketplace/petshop/admin.html">Admin</a></li>
            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/marketplace/petshop/images/dogbuscuits.jpg" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            ...
                            <p><button onclick="window.location.href='/marketplace/petshop/products/dogbiscuits.html';">Add to Cart</button></p>
                          </div>
                    </div>
