            ...
            <div id="content-inner">
                ...
                <main id="contentbar">
                    <div class="article">
                        ...
                        <div class="card">
                            <img src="/marketplace/petshop/images/dogdisc.jpg" alt="Denim Jeans" style="max-height:450px; max-width:450px;">
                            ...
                            <p><button onclick="window.location.href='/marketplace/petshop/products/dogdisc.html';">Add to Cart</button></p>
                          </div>
                    </div>
